                ...
                <div class="col-md-6">
                    <div class="card card-warning">
                      <div class="card-header">
                        <h3 class="card-title">Cadastrar Agricultor</h3>
                      </div>
                      <form role="form" method="POST" action="{{ route('Painel.Agricultores.store') }}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="cadpro" id="cadpro" placeholder=" " required/>
                                </div>
                            </div>
